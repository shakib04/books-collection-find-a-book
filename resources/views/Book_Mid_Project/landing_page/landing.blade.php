...
<head>
    ...
    <link href="{{ asset('frontend/css/landing_home.css') }}" rel="stylesheet" />
</head>
    ...
    <main class="flex-shrink-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container px-5">
                <a class="navbar-brand" href="index.html">Books E-Business</a>
                ...
                <div class="row gx-5 align-items-center justify-content-center">
                    <div class="col-lg-8 col-xl-7 col-xxl-6">
                        <div class="my-5 text-center text-xl-start">
                            <h1 class="display-5 fw-bolder text-white mb-2">Books Collection and a Platform for Shop Owner
                            </h1>
                            ...
                            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                <a class="btn btn-primary btn-lg px-4 me-sm-3" href="#features">Shop Owner</a>
                                <a class="btn btn-outline-light btn-lg px-4" href="{{url('/book/list')}}">Buy Books</a>
                            </div>
                        </div>
                    </div>
