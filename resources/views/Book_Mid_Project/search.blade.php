...
<head>
    ...
    <link href="https://colorlib.com/etc/searchf/colorlib-search-10/css/main.css" rel="stylesheet" />
...
<body>
                    ...
                    <div class="row third">
                        <div class="input-field">
                            ...
                            <div class="group-btn">
                                ...
                                <a href="{{ url()->previous() }}" class="btn btn-delete" > Back</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js" data-cf-beacon='{"rayId":"660e684b4d7be9af","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.5.2","si":10}'></script>
</body>
